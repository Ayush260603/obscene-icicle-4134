...
// image  
    ...
    // the things that will go inside divs are created
            ...
            div1.append(name,date,type,phrase,hr,rating,salary,hr,city,country,category,department,jobtype,desc,button,view)
            div2.append(image)
    ...
    function otpcheck(event){
        ...
        if(k==1234){
            ...
            document.querySelector(".problem>h1").innerText="Applying for Job Successful!"
            document.querySelector(".problem>h2").innerText="Lets find more Jobs to Apply"
            ...
            document.querySelector(".problem>h2").innerText="Please Enter Correct OTP"
